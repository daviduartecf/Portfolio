...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // You can add additional logic to handle form submission (e.g., AJAX request)
    //var loginForm = document.getElementById("login-form");
    //loginForm.addEventListener("submit", function (event) {
       // event.preventDefault();
        // Add your login logic here, for example, using AJAX to submit the form data
        //console.log("Form submitted. Handle login logic here.");
    //});
